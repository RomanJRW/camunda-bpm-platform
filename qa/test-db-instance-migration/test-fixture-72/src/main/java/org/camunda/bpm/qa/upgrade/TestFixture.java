...
import org.camunda.bpm.qa.upgrade.scenarios.oplog.OperationLogWithoutProcDefKeyScenario;
...
public class TestFixture {
  ...
  public static void main(String[] args) {
    ...
    runner.setupScenarios(OperationLogWithoutProcDefKeyScenario.class);
