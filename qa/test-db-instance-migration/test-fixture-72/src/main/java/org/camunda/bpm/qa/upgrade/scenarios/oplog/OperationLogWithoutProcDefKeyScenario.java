 ...
 */
package org.camunda.bpm.qa.upgrade.scenarios.oplog;
...
public class OperationLogWithoutProcDefKeyScenario {

  @Deployment
  public static String deploy() {
    return "org/camunda/bpm/qa/upgrade/oplog/oneTaskProcess.bpmn20.xml";
  }
    ...
    return (engine, scenarioName) -> {
      ...
      for (int i = 0; i < 5; i++) {
        String processInstanceId = engine.getRuntimeService()
            .startProcessInstanceByKey("OperationLogWithoutProcDefKeyScenario")
            .getId();
