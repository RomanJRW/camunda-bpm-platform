 ...
 */
package org.camunda.bpm.qa.upgrade.scenarios7130.oplog;
...
public class HistoricInstancePermissionsAuthorizationTest {
  ...
  @Test
  public void shouldEnforceAuthorizationForOperationLog() {
    // given
    ...
    HistoricProcessInstance historicProcessInstance =
        historyService.createHistoricProcessInstanceQuery()
            .processDefinitionKey("OperationLogWithoutProcDefKeyScenario")
            .list()
            .get(0);
  ...
  @Test
  public void shouldSkipAuthorizationForOperationLog() {
    // given
